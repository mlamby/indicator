...
class Indicator::AutoGen::CdlDarkCloudCover < Indicator::Base
  # Penetration <Double>
  ...
  def initialize(*args)
    if args.first.is_a? Hash
      h = args.first
      @penetration = h[:penetration] || 5.000000e-1
    else
      @penetration = args[0] || 5.000000e-1 
    end
    
    @func = TaLib::Function.new("CDLDARKCLOUDCOVER")
  end
